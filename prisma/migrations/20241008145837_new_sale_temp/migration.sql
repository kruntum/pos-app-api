...
-- AddForeignKey
ALTER TABLE "SaleTempDetail" ADD CONSTRAINT "SaleTempDetail_tasteId_fkey" FOREIGN KEY ("tasteId") REFERENCES "Taste"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SaleTempDetail" ADD CONSTRAINT "SaleTempDetail_salTemptID_fkey" FOREIGN KEY ("salTemptID") REFERENCES "SaleTemp"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
